...
mkdir -p $ZOOBASE
cd $ZOOBASE
wget http://www-eu.apache.org/dist/zookeeper/stable/zookeeper-${ZOOVERS}.tar.gz
...
server.1=172.23.2.37:2888:3888
server.2=172.23.2.38:2888:3888
server.3=172.23.2.39:2888:3888
server.4=172.23.2.40:2888:3888
server.5=172.23.2.41:2888:3888
EOF            
...
case \$1 in
    start)   /home/server/zookeeper-3.4.12/bin/zkServer.sh start ;;
    stop)    /home/server/zookeeper-3.4.12/bin/zkServer.sh stop ;;
    status)  /home/server/zookeeper-3.4.12/bin/zkServer.sh status ;;
    restart) /home/server/zookeeper-3.4.12/bin/zkServer.sh restart ;;
